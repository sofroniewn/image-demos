...
with gui_qt():
    ...
    ch2 = viewer.add_image(cells[:, 2, :, :], name='cells', colormap='green', clim=(410.0, 700.0), blending='additive')

    ch3 = viewer.add_image(cells[:, 3, :, :], name='yellow spots',
                           clim_range=(300, 700), clim=(420.0, 500.0), colormap='yellow', blending='additive')

    ch4 = viewer.add_image(cells[:, 4, :, :], name='DAPI', colormap='blue', clim=(500.0, 1300.0), blending='additive')
